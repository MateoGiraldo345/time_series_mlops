...
```json
{"prediction":[0.00063509,0.00063515,0.0006443,0.00064239,0.00064909,0.00063269,0.00063413],"lag_usado":60,"horizonte":7,"descripcion":"Volatilidad predicha para los próximos 7 minutos usando los últimos 60 valores de volatilidad histórica."}
```
